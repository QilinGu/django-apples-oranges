"""
Django development settings for showlike project.
...
SECRET_KEY = r"&8+nn8e56z^gh98t3q+14^$)*q9&zbccctc31l_u(zi*-u=i+)"
...
WSGI_APPLICATION = 'showlike.wsgi.application'
